...
1. Ensure the repository contains `salaries_clean.csv` at the project root.
...
3. Open the desired notebook (for example, `SQL_pract_2.ipynb`) in Jupyter and run the cells. The notebooks create an in-memory DuckDB connection and load the CSV into a `salaries` table.
